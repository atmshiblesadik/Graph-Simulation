...
public class input_bfs extends JPanel{
	private static boolean create=false;
	private static input_bfs registerref=null;
	...
	public static input_bfs getRef() {
		if(create==false) {
			registerref=new input_bfs();
			create=true;
			return registerref;
	...
	private void initialize() {
		JLabel welcome = new JLabel("Please give input for BFS");
...
//		JLabel picLabel = new JLabel(new ImageIcon("men.png"));
	...
	private void initialize2(){
		...
		add(simulate);
		simulate.addActionListener(new bfs_simulate());
		//back_button
